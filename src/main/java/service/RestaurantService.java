...
public class RestaurantService {
    ...
    public RestaurantService() {
        ...
        // Initialize Data
        Restaurant res1 = new Restaurant("name1", "linkToRestaurant1", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.NORMAL, RestaurantType.INDIAN, new Location(), new ArrayList<>(), commentstest);
        Restaurant res2 = new Restaurant("name2", "linkToRestaurant2", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.CHEAP, RestaurantType.ITALIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res3 = new Restaurant("name3", "linkToRestaurant3", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.COSTLY, RestaurantType.CHINESE, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res4 = new Restaurant("name4", "linkToRestaurant4", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.NORMAL, RestaurantType.ITALIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res5 = new Restaurant("name5", "linkToRestaurant5", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.NORMAL, RestaurantType.INDIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res6 = new Restaurant("name6", "linkToRestaurant6", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.COSTLY, RestaurantType.ITALIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res7 = new Restaurant("name7", "linkToRestaurant7", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.NORMAL, RestaurantType.CHINESE, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res8 = new Restaurant("name8", "linkToRestaurant8", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.CHEAP, RestaurantType.ITALIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res9 = new Restaurant("name9", "linkToRestaurant9", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.CHEAP, RestaurantType.INDIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
        Restaurant res10 = new Restaurant("name10", "linkToRestaurant10", List.of("/pathPicture1", "/pathPicture2"), PriceCategory.NORMAL, RestaurantType.ITALIAN, new Location(), new ArrayList<>(), new ArrayList<Comment>());
